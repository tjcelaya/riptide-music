<?php /* Smarty version Smarty-3.1.13, created on 2013-03-19 21:01:38
...
"/>
            ...
            <form action='/~celaya/riptideMusic/api/dimport/<?php echo $_smarty_tpl->tpl_vars['dID']->value;?>
' method='POST'>
                <button class='btn' value='<?php echo $_smarty_tpl->tpl_vars['dID']->value;?>
' type='submit'>
